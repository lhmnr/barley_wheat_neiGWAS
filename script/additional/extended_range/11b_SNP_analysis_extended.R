...
#this script is to get an overwiev of sig. SNPs in extended range
...
res_col = system(paste0("ls ./results/",species,"/neiGWAS_extended/data_collection_neiGWAS/*.csv"), intern=TRUE)
...
if(!file.exists(paste0("results/",species,"/SNP_analysis_extended"))){
  dir.create(path = paste0("results/",species,"/SNP_analysis_extended"))
}
if(!file.exists(paste0("results/",species,"/SNP_analysis_extended/sig_SNPs_vs_dist_",daynumber))){
  dir.create(path = paste0("results/",species,"/SNP_analysis_extended/sig_SNPs_vs_dist_",daynumber))
}
...
ggsave(filename = paste0("results/",species,"/SNP_analysis_extended/sig_SNPs_vs_dist_",daynumber,"/significant_SNPs_vs_distance.png"),plot=sig_SNPs_plot,width=4000,height=3000,units="px",device="png")
...
ggsave(filename = paste0("results/",species,"/SNP_analysis_extended/sig_SNPs_vs_dist_",daynumber,"/significant_SNPs_vs_distance_3t.png"),plot=sig_SNPs_plot,width=4000,height=3000,units="px",device="png")
rm(sig_SNPs_plot)
...
write_csv(GWAS_results_sig, file = paste0("results/",species,"/SNP_analysis_extended/sig_SNPs_vs_dist_",daynumber,"/significant_SNPs_all_dist.csv"))
...
write_csv(inflatedness, file = paste0("results/",species,"/SNP_analysis_extended/sig_SNPs_vs_dist_",daynumber,"/inflatedness_all_dist.csv"))
...
ggsave(filename = paste0("results/",species,"/SNP_analysis_extended/sig_SNPs_vs_dist_",daynumber,"/inflatedness_vs_distance_disc.png"),plot=inflatedness_plot,width=4000,height=3000,units="px",device="png")
...
ggsave(filename = paste0("results/",species,"/SNP_analysis_extended/sig_SNPs_vs_dist_",daynumber,"/inflatedness_vs_distance.png"),plot=inflatedness_plot,width=4000,height=3000,units="px",device="png")
rm(inflatedness_plot)
