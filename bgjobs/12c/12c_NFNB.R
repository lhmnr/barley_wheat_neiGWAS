...
png(filename = paste0("results/",species,"/PVE_analysis/multiMAF/extended/",daynumber,"_",poolName,"/",poolName,"_distance_vs_MAF_rgb_map_with_sigSNPs.png"),width=1600,height=800,units="px")
bgc <- par(bg = "black")
