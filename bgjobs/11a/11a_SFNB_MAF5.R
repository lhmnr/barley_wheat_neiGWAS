...
#extended range is up to nei dist of 16

#while those bigger distances are less meaningful, they may help to
#give an impression how p, PVEnei and inflatedness develop with distance
...
if(!file.exists(paste0("results/",species,"/neiGWAS_extended"))){
  dir.create(path = paste0("results/",species,"/neiGWAS_extended"))
}
if(!file.exists(paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName))){
  dir.create(path = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName))
}
if(!file.exists(paste0("results/",species,"/neiGWAS_extended/data_collection_neiGWAS"))){
  dir.create(path = paste0("results/",species,"/neiGWAS_extended/data_collection_neiGWAS"))
}

#export data
write_csv(gwas_results, file = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/neiGWAS_results_",poolName,".csv"))
write_csv(dist_results, file = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/PVEnei_results_",poolName,".csv"))
write_csv(gwas_results, file = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/topSNP_per_dist_",poolName,".csv"))

#copy neiGWAS_results file manually to "results/[species]/neiGWAS_extended/data_collection_neiGWAS" to use them for further analysis
...
if(wished_plots[1]){
  ...
  args$xlab <- "scale"
  args$ylab <- "PVE_nei"
  png(filename = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/",poolName,"_PVEnei.png"),width=800,height=600,units="px")
...
if(wished_plots[4]){
  ...
  ggsave(filename = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/",poolName,"_topSNPs_distance.png"),plot=topSNPs_dist_disc,width=4000,height=3000,units="px",device="png")
...
if(wished_plots[5]){
  ...
  ggsave(filename = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/",poolName,"_topSNPs_distance_small.png"),plot=topSNPs_dist_disc_small,width=4000,height=3000,units="px",device="png")
...
if(wished_plots[2]){
  ...
  ggsave(filename = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/",poolName,"_topSNPs_distance_continuous.png"),plot=topSNPs_dist_cont,width=4000,height=3000,units="px",device="png")
...
if(wished_plots[3]){
  ...
  ggsave(filename = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/",poolName,"_topSNPs_distance_continuous_small.png"),plot=topSNPs_dist_cont_small,width=4000,height=3000,units="px",device="png")
  rm(topSNPs_dist_cont_small)
}

#manhattan plots for all distances
if(wished_plots[6]){
  if(!file.exists(paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/manhattan"))){
    dir.create(path = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/manhattan"))
  }
  ...
  for(j in result_rows){
    ...
    png(filename = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/manhattan/",poolName,"_manhattan_d",d,".png"),width=1600,height=800,units="px")
    ...
    dev.off()
    png(filename = paste0("results/",species,"/neiGWAS_extended/",daynumber,"_",poolName,"/manhattan/",poolName,"_qq_d",d,".png"),width=1600,height=800,units="px")
