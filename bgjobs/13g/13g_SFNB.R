...
#this version includes an additional part for the "sxn"-term
...
if(!file.exists(paste0("results/",species,"/PVE_analysis_asym"))){
  dir.create(paste0(path = "results/",species,"/PVE_analysis_asym"))
}
if(!file.exists(paste0("results/",species,"/PVE_analysis_asym/multiMAF"))){
  dir.create(paste0(path = "results/",species,"/PVE_analysis_asym/multiMAF"))
}
if(!file.exists(paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName))){
  dir.create(paste0(path = "results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName))
}
...
for(MAF_i in MAF){
  ...
  #create output folder if necessary
  if(!file.exists(paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/MAF",MAF_i))){
    dir.create(paste0(path = "results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/MAF",MAF_i))
  }
  write_csv(PVE_results, file = paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/MAF",MAF_i,"/PVE_results_asym_",poolName,".csv"))
  ################################# plot
  library(ggplot2)
  library(tidyr)
  ...
  ggsave(filename = paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/MAF",MAF_i,"/",poolName,"_asym_PVE_vs_distance.png"),plot=PVE_plot,width=4000,height=3000,units="px",device="png")
  rm(PVE_plot)
  #clean
  rm(D)
  rm(g_nei)
...
write_csv(PVE_results_multiMAF, file = paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/PVE_results_asym_multiMAF_",poolName,".csv"))
...
PVE_plot = ggplot(plot_data, aes(x = dist, y = PVE, fill = plot_levels)) + geom_bar(position="stack",stat="identity") + facet_grid(~ MAF) + ggtitle("PVE partitioning of each distance") + xlab("distance of included neighbours, per MAF") + ylab("PVE")
ggsave(filename = paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/",poolName,"_PVE_vs_distance_per_MAF.png"),plot=PVE_plot,width=4000,height=3000,units="px",device="png")
rm(PVE_plot)

#PVE vs. MAF, per distance
PVE_plot = ggplot(plot_data, aes(x = as.factor(MAF), y = PVE, fill = plot_levels)) + geom_bar(position="stack",stat="identity") + facet_grid(~ dist) + ggtitle("PVE partitioning of each distance") + xlab("MAF, per distance of included neighbours") + ylab("PVE")
ggsave(filename = paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/",poolName,"_PVE_vs_MAF_per_distance.png"),plot=PVE_plot,width=4000,height=3000,units="px",device="png")
rm(PVE_plot)
...
ggsave(filename = paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/",poolName,"_distance_vs_PVE_sum_per_type_and_MAF.png"),plot=PVE_plot,width=4000,height=3000,units="px",device="png")
rm(PVE_plot)
...
png(filename = paste0("results/",species,"/PVE_analysis_asym/multiMAF/",daynumber,"_",poolName,"/",poolName,"_distance_vs_MAF_rgb_map.png"),width=1600,height=800,units="px")
bgc <- par(bg = "black")
